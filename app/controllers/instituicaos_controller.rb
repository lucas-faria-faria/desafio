class InstituicaosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @instituicao.save
        format.html { redirect_to @instituicao, notice: 'Instituicao criada com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @instituicao.update(instituicao_params)
        format.html { redirect_to @instituicao, notice: 'Instituicao foi atualizada.' }
  ...
  private
    ...
    def instituicao_params
      params.require(:instituicao).permit(:nome, :nota_geral)
    end
end
