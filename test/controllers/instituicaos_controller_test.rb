...
class InstituicaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instituicao" do
    assert_difference('Instituicao.count') do
      post instituicaos_url, params: { instituicao: { nome: @instituicao.nome, nota_geral: @instituicao.nota_geral } }
    end
  ...
  test "should update instituicao" do
    patch instituicao_url(@instituicao), params: { instituicao: { nome: @instituicao.nome, nota_geral: @instituicao.nota_geral } }
