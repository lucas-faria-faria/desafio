...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { nome: @aluno.nome, nota_geral: @aluno.nota_geral } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { nome: @aluno.nome, nota_geral: @aluno.nota_geral } }
